...
insert into Sys_Menu(menuid,seqno,parentid,menutitle,iconname,pagename,issystemmenu,deleteflag,createtime,createuser,updatetime,updateuser) values('104','4','100','数据字典','fa-sitemap','Sys007_CodeList','1','0','2017/9/13  14:45:00','admin','2017/9/13  14:45:00','admin');
insert into Sys_Menu(menuid,seqno,parentid,menutitle,iconname,pagename,issystemmenu,deleteflag,createtime,createuser,updatetime,updateuser) values('105','5','100','图片管理','fa-picture-o','Sys008_PhotoInfo','1','0','2017/9/13  14:45:00','admin','2017/9/13  14:45:00','admin');
insert into Sys_Menu(menuid,seqno,parentid,menutitle,iconname,pagename,issystemmenu,deleteflag,createtime,createuser,updatetime,updateuser) values('106','6','100','商品基本信息','fa-cutlery','Sys009_Commodity','1','0','2017/9/13  14:45:00','admin','2017/9/13  14:45:00','admin');
insert into Sys_Menu(menuid,seqno,parentid,menutitle,iconname,pagename,issystemmenu,deleteflag,createtime,createuser,updatetime,updateuser) values('107','7','100','街道信息','fa-road','Sys005_Rode','1','0','2017/9/13  14:45:00','admin','2017/9/13  14:45:00','admin');
insert into Sys_Menu(menuid,seqno,parentid,menutitle,iconname,pagename,issystemmenu,deleteflag,createtime,createuser,updatetime,updateuser) values('108','8','100','小区信息','fa-home','Sys006_Community','1','0','2017/9/13  14:45:00','admin','2017/9/13  14:45:00','admin');
insert into Sys_Menu(menuid,seqno,parentid,menutitle,iconname,pagename,issystemmenu,deleteflag,createtime,createuser,updatetime,updateuser) values('109','2','0','商户管理','fa-handshake-o','','1','0','2017/9/13  14:45:00','admin','2017/9/13  14:45:00','admin');
insert into Sys_Menu(menuid,seqno,parentid,menutitle,iconname,pagename,issystemmenu,deleteflag,createtime,createuser,updatetime,updateuser) values('110','1','109','商户基本信息','fa-id-card-o','Dm001_BasicInfo','1','0','2017/9/13  14:45:00','admin','2017/9/13  14:45:00','admin');
insert into Sys_Menu(menuid,seqno,parentid,menutitle,iconname,pagename,issystemmenu,deleteflag,createtime,createuser,updatetime,updateuser) values('111','2','109','商户商品信息','fa-window-restore','','1','0','2017/9/13  14:45:00','admin','2017/9/13  14:45:00','admin');
insert into Sys_Menu(menuid,seqno,parentid,menutitle,iconname,pagename,issystemmenu,deleteflag,createtime,createuser,updatetime,updateuser) values('112','3','109','商户订单','fa-map-o','','1','0','2017/9/13  14:45:00','admin','2017/9/13  14:45:00','admin');
insert into Sys_Menu(menuid,seqno,parentid,menutitle,iconname,pagename,issystemmenu,deleteflag,createtime,createuser,updatetime,updateuser) values('113','3','0','用户管理','fa-user-o','','1','0','2017/9/13  14:45:00','admin','2017/9/13  14:45:00','admin');
insert into Sys_Menu(menuid,seqno,parentid,menutitle,iconname,pagename,issystemmenu,deleteflag,createtime,createuser,updatetime,updateuser) values('114','1','113','用户基本信息','fa-user-circle-o','Um001_BasicInfo','1','0','2017/9/13  14:45:00','admin','2017/9/13  14:45:00','admin');
